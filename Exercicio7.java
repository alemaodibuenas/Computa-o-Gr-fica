...
public class Exercicio7 implements GLEventListener, KeyListener {

	int p = 5;// aqui é a variavel global , p 5 a 20
	...
	private void desenhaEstela(GL2 gl, float pontas) {
		for (int i = 0; i <= 20; i++) {
	...
	public void display(GLAutoDrawable drawable) {
		...
		gl.glPushMatrix();
		desenhaEstela(gl, p);// p numero de pontas que a estrela vai ter
		gl.glPopMatrix();
